                ...
                <b-row class="justify-content-md-center">
                    ...
                    <form v-on:submit="Validacao">
                        ...
                        <b-col cols="12" md="12">
                            ...
                            <input v-model="nome" class="texto"
                                type="text" placeholder="Nome" size="md"/>
                            </div>
                        </b-col>
                        ...
                        <b-col cols="12" md="12">
                            <div id="campoTexto">
                                ...
                                <input v-model="telefone" type="tell" class="texto"
                                    placeholder="Telefone" size="md" required/>
                            </div>
                        </b-col>
                        ...
                        <b-col cols="12" md="12">
                            <div id="campoTexto">
                                <b-icon class="icones"  icon="lock-fill"></b-icon>
                                <input v-model="confirmSenha" type="password" class="texto"
                                    placeholder="Confirmar Senha" size="md" required/>
                            </div>
                            <small v-show="senhaIncorreta==true" class="texto">A senha é diferente</small>
                        </b-col>
                            
                        <b-col cols="12" md="auto">
                            <p><b-form-checkbox :state="checkbox" v-model="aceitar"> Aceitar os termos de uso de privacidade</b-form-checkbox></p>
                        </b-col>

                        <b-col cols="11" md="11">
                            <button type="button"  size="md" 
                            @click="Validacao" class="mb-3 btn">
                                Criar Conta
                            </button>
                        </b-col>
